...
namespace Week1Practice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Myname is " + myName + " and I'm a beast of a programmer");
            ...
            for (int i = 0; i < myName.Length; i++)
            {
                ...
                //Console.WriteLine("My name, " + myName + " has " + (Console.WriteLine(i)) + " in it.");
            }
            ...
            string [] listArray = productList.Split('productList.Count');
            for (int i = 0; i < productList.Count.Length;  )
    ...
    satic void Multiply (int num1, int num2)
{
    return num1 * num2;
}
    ...
    for (i = startNum; i < endNum; i++)
{
    ...
    Console.WriteLine(LoopThis);
            ...
            static int SuperLoop (startNum, endNum, increment)
{
    int loopCount = x;
    for (i = 0; i <)
}
...
{ 
    ...
    Console.WriteLine(NewGreeting(name(Neil deGrasse-Tyson));
            ...
            Console.WriteLine(NewGreeting(name(myName));
    ...
    static int TripleIt (int number)
{
    ...
    number = 10;
    Console.WriteLine("10 tripled is " + TripleIt);
    ...
    int number = myAge;
    Console.WriteLine(myAge + "tripled is " + TripleIt);
    ...
    static int RealMultiply (int num1, num2)
{
    return num1 * num2
}
    ...
    num1 = 5
    num2 = 10
    Console.WriteLine(RealMultiply);
    ...
    SuperLoop (startNum = RealMultiply(int num1 = 1, int num1 = 5); endNum = TripleIt(myAge); increment = TripleIt(myAge - 10))
    ...
    SuperLoop (startNum = RealMultiply(int num1 = 1, int num2 = (TripleIt(3))); endNum = TripleIt(RealMultiply(num1 = myAge, num2 = 7)); increment = TripleIt(myAge - RealMultiple(num1 = 2, num2= 4)));
