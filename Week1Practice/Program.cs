...
namespace Week1Practice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(productsList.ElementAt(i));
                //Console.WriteLine(productList[i]);
                //List is like an array 
                //A list can hold ANYTHING -- A list has much more flexibility
            }
            // FOR LOOP PRACTICE
            ...
            //if i = 11 then we would never get an even number
            ...
            Console.WriteLine("My product list has " + listItem + " in it.");
            ...
            // 1. Create a function called "NewGreeting" that takes one string parameter called "name".  This fun0ction will return a string in the format of "Hello, <name>"
        ...
        static void SuperLoop(int startNum, int endNum, int increment)
        {
            ...
            for (int i = startNum; i <= endNum; i = increment + i)
            {
                Console.WriteLine(i);
                loopCount++;
            }
